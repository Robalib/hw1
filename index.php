...
<html>
    <head>
        <meta charset="utf-8">
        <title>GCDS: abbigliamento, scarpe e accessori di lusso</title>
        ...
        <header>
          ...
          <nav>
            ...
            <div id="simbols">
              ...
              <a id="simbol_login"><img src="img/alien-dark.webp" /></a>
          ...
          <div id="login" class="hidden">
            <div id="tendina_login">
              ...
              <div>
              <a href="signup.php">Non sei ancora un member? Registrati</a>
              </div>
            </div>
          </div>
        </header>

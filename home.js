const new_images = [
  ...
  function showAccount() {
    ...
    login.addEventListener('click', hideAccount);
  }
  ...
  function handlerAccount(event) {
    event.stopPropagation();
  }
  
  document.querySelector('#simbol_account').addEventListener('click', showAccount);
  document.querySelector('#tendina_account').addEventListener('click', handlerAccount);
